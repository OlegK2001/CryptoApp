...
class Cripto:
    ...
    def apply_feistel_round(
        ...
        transformed_block = (key_part_1, iteration_constant)  # Операция XOR 1 части ключа со счетчиком
    ...
    def key_dev(self):
        ...
        imitation_insert = self.KEY[128*12+1:]
    ...
    def main2(self):
        ...
        print('imitation_insert: ', hex(int(imitation_insert)))
...
Code = Cripto(
    '1110011011000110111011111011100010001001111101011100101001010101010101010101010101010101010101101010111010110' + \
    ...
    ''
)
Code.start()
''
Code.main2()